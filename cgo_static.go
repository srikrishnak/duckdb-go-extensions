...
/*
#cgo LDFLAGS: -licu_extension -ltpch_extension -ltpcds_extension -lsubstrait_extension -lparquet_extension -ljson_extension -lcore_functions_extension -lduckdb_mbedtls
